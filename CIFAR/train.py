...
parser.add_argument('--model', default='resnet32_global', type=str, help='model type; choose from: "resnet32", "resnet32_global"')
...
parser.add_argument('--constant_Dxy', default=False, type=bool, help='specify whether PDE parameters Dx and Dy are constant')
parser.add_argument('--custom_uv', default='identity', type=str, help='specify type of learnable u and v')
parser.add_argument('--custom_dxy', default='identity', type=str, help='specify type of learnable Dx and Dy')
